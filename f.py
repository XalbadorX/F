#YATIM YANG CURI SCRIPT
#AUTOR : XALBADOR
#GITHUB : https://github.com/XalbadorX
import socket
import struct
import codecs,sys
import threading
...
print("         ██╔╝╚██╗███████╗██████╦╝██████╔╝╚█████╔╝██║░░██║")
print("         ╚═╝░░╚═╝╚══════╝╚═════╝░╚═════╝░░╚════╝░╚═╝░░╚═╝")
print("         PAKET!!!! FROM: %s  XALBADOR: %s"%(orgip,port))
print("\033[91m #########################################################\n")
print("         AWAS KAU COK YANG MAU CURI SCRIPT KU BANTAI HABIS KAU KONTOL")          
